...
public class JsapiServiceExample {
  ...
  public static void main(String[] args) {
    ...
    // ... 调用接口
    try {
      PrepayWithRequestPaymentResponse  res =  JsapiServiceExample.prepay();
      System.out.println("=============");
...
//    Transaction  res= queryOrderByOutTradeNo();
//
//    System.out.println(res);
  ...
  /** JSAPI支付下单 */
  public static PrepayWithRequestPaymentResponse  prepay() {
